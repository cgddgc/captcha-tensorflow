...
home_root = "E:/MyProjects/captcha-tensorflow/"  # 在不同操作系统下面Home目录不一样
workspace = join(home_root, "work/crack/y-capt-data/capt-python-36/")  # 用于工作的训练数据集
